...
bool OcrEngine::setLang(QString lang)
{
    ...
    QString exeDirpath = QCoreApplication::applicationDirPath() + QDir::separator() + "tessdata" +  QDir::separator();
...
void OcrEngine::setConfigFile(const QString &value)
{
...
void OcrEngine::setPageSegMode(tesseract::PageSegMode mode)
{
...
QString OcrEngine::performOcrEx(PIX *pixs)
{
    mutex.lock();
