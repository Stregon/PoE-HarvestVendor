...
private:
    ...
    void ocrScreenHarvest(QRect rect, QString pattern, double aspectRatioForLevel);
    QString ocrScreenRect(QRect rect);
    QString ocrScreenImage(QImage img);
    ...
    //static QString HarvestThread(OcrTaskInput &ocrInput);
