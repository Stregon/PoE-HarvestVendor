...
Handle_Reforge(craftText, ByRef out) {
    ...
    if TemplateExist(craftText, translate("colour")) {
        ...
        reforge2color := ["Red, Blue and Green"
            , "Red and Green"
            , "Blue and Green"
            , "Red and Blue"
            , "White"]
...
Handle_Set(craftText, ByRef out) {
    ...
    if TemplateExist(craftText, translate("Abyss/Timeless")) {
